(function () {
  ...
  const I18N = {
    en: {
      ...
      'btn.chord_remove': 'Remove chord tags',
      'help.chord_remove': 'Removes chord tags from caption and lyrics, and clears chord conditioning markers from the UI state.',
      ...
      'status.chord_removed': 'Chord tags removed from style and lyrics.',
      ...
      'help.cover_noise_strength': 'Controls melody retention in Remix mode. Recommended: use the SFT model with a value of 0.1–0.25. A small increase restores the melody, but style transfer may require additional prompt tuning. (0 = pure noise/no cover, 1 = closest to original audio).',
      'help.audio_cover_strength': 'Control how many denoising steps use LM-generated codes.',
    ...
    it: {
      ...
      'btn.chord_remove': 'Rimuovi tag accordi',
      'help.chord_remove': 'Rimuove i tag accordi da caption e lyrics, e pulisce i marker di conditioning accordi nello stato UI.',
      ...
      'status.chord_removed': 'Tag accordi rimossi da stile e lyrics.',
      ...
      'help.cover_noise_strength': 'Controlla quanto della melodia originale viene mantenuta in Remix. 0 = rumore puro (nessun cover), 1 = più vicino all’audio originale. Consiglio: SFT 0.10–0.25.',
      'help.audio_cover_strength': 'Controlla quanti step di denoise usano i codici LM generati.',

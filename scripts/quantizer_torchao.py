...
if is_torchao_available():
    _SUPPORTED = [
        getattr(torchao.quantization, "Float8WeightOnlyConfig", None),
        getattr(torchao.quantization, "Float8DynamicActivationFloat8WeightConfig", None),
    ]
    SUPPORTED_SAFE_SERIALIZATION_CONFIGS = [c for c in _SUPPORTED if c is not None]
